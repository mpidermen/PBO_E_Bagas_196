...
public class Tugas1 {
    ...
    public static void main(String[] args) {
        ...
        String nimLengkap = "202410370110196"; // Ganti dengan NIM lengkap Anda
        ...
        if (pilihan == 1) {
            ...
            if (nama.equals("bagas") && nim.equals(tigaDigitTerakhirNIM)) { // Ganti "Nama Kalian" dengan nama Anda
